...
title: Plateformes prises en charge pour MIM 2016 | Microsoft Identity Manager
...
|-------------------|--------------|-------------|
|**Synchronisation MIM**|Windows Server | Windows Server 2008 R2 SP1<br/>Windows Server 2012<br/>Windows Server 2012 R2|
||Base de données de synchronisation MIM |SQL Server 2008 R2 SP3<br/>SQL Server 2012 SP2<br/>SQL Server 2014 SP1 |
||Active Directory pour l’attribution d’utilisateurs, PCNS et la synchronisation de liste d’adresses globale (facultatif)|Windows Server 2008 R2 SP1<br/>Windows Server 2012<br/>Windows Server 2012 R2 |
...
|| Système connecté supplémentaire (facultatif) | Services de domaine Active Directory<br/>Active Directory<br/>Services LDS (Lightweight Directory Services)<br/>SQL Server 2000 ou version ultérieure<br/>SharePoint Server 2013<br/>Autres produits tiers |
| **Service MIM** (à l’exception du scénario PAM) | Windows Server | Windows Server 2008 R2 SP1<br/>Windows Server 2012<br/>Windows Server 2012 R2 |
|| Base de données du service MIM | SQL Server 2008 R2 SP3<br/>SQL Server 2012 SP2<br/>SQL Server 2014 SP1 |
|| Exchange pour les messages électroniques d’approbation et de gestion de groupes du service MIM (facultatif) | Exchange Server 2007 SP3 (avec la console de gestion Exchange installée)<br/>Exchange Server 2010 SP3<br/>Exchange Server 2013 SP1 |
| **Service et portail MIM** (scénario PAM uniquement)| Windows Server | Windows Server 2012<br/>Windows Server 2012 R2 |
|| Active Directory pour la forêt PAM d’environnement bastion | Windows Server 2012 R2 |
|| Active Directory pour les forêts existantes | Windows Server 2008 ou version ultérieure |
|| Base de données du service MIM | SQL Server 2008 R2 SP3<br/>SQL Server 2012 SP2<br/>SQL Server 2014 SP1 |
|| SharePoint | SharePoint Foundation 2010<br/>SharePoint Foundation 2013 SP1 |
|| Serveur de messagerie pour les messages électroniques d’approbation et de gestion de groupes du service MIM (facultatif) | Exchange Server 2007 SP3 (avec la console de gestion Exchange installée)<br/>Exchange Server 2010 SP3<br/>Exchange Server 2013 SP1 |
|| Navigateur | Internet Explorer 8, 9, 10 ou 11 |
| **Rapports du service MIM** | Windows Server | Windows Server 2012 |
